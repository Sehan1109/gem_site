...
const JEWELRY_MOCK = [
  { id: 1, name: "Serendib Sapphire Drop", description: "A Ceylon sapphire necklace shaped by Sri Lanka's coastal craftsmanship and vibrant island heritage.", price: "Upon Request", category: "Necklace", sellerId: 1, img: "https://plus.unsplash.com/premium_photo-1681276170092-446cd1b5b32d?q=80&w=688&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" },
  { id: 2, name: "Temple Padparadscha Ring", description: "A delicate platinum ring featuring Sri Lanka's rare pink-orange padparadscha, evoking classic temple art.", price: "Private Sale", category: "Ring", sellerId: 2, img: "https://images.unsplash.com/photo-1481980235850-66e47651e431?q=80&w=688&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" },
  { id: 3, name: "Ratnapura Ruby Suite", description: "Matched ruby earrings set with Sri Lankan rubies and diamond accents for an evening-ready statement.", price: "Inquire", category: "Earrings", sellerId: 1, img: "https://images.unsplash.com/photo-1535632066927-ab7c9ab60908?q=80&w=1000&auto=format&fit=crop" },
  { id: 4, name: "Galle Pearl Collar", description: "A premium pearl collar inspired by Sri Lanka's historic pearl trade and coastal elegance.", price: "Upon Request", category: "Bracelet", sellerId: 3, img: "https://images.unsplash.com/photo-1611591437281-460bfbe1220a?q=80&w=1000&auto=format&fit=crop" },
];
